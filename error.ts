...
/**
 * This class provides a wrapper for network errors when making requests to Webhooks API
 */
export class BrexWebhooksError extends Error {
  /**
   * The response body
   */
